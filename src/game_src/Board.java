...
public class Board {
	...
	public boolean dictionaryLegal(DictionaryManager dm, Word w) {
		return dm.query("./src/resources/words_alpha.txt", w.toString());
	}
...
//	protected void loadGame(HashMap<Tile,Integer> game_tiles) {
//		for (Map.Entry<Tile, Integer> entry : game_tiles.entrySet()) {
//			Tile key = entry.getKey();
//			Integer value = entry.getValue();
//			tiles[value/15][value%15]=key;
//			}
//		}
//	}
